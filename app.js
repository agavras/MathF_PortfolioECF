...
imgwrapper.addEventListener("mouseover", animateGif);
imgwrapper.addEventListener("mouseout", animateStopGif);
...
// Anime le gif de la page projet au passage de la sourie
function animateGif() {
    imgwrapper.className = "animate__animated animate__rubberBand animate__1";
}
function animateStopGif() {
    imgwrapper.className = "empty";
}
...
function changeCSSVariables() {
    if (currentMode === "DARK") {
        ...
        document.documentElement.style.setProperty("--bgBoxColor", "#bd52a2d0");
        currentMode = "LIGHT";
